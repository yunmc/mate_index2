...
import { priceList, createOrder, payPay, payPaySuccess, payPayCancel,proPay,proPaySuccess,proPayCancel } from '@/api/order';
export const useOrderStore = defineStore({
    ...
    actions: {
        ...
        getProPaySuccess(options: any) {
            return new Promise((resolve, reject) => {
                proPaySuccess(options)
                    .then((response: any) => {
                        resolve(response);
                    })
                    .catch((error: any) => {
        ...
        getProPayCancel(options: any) {
            return new Promise((resolve, reject) => {
                proPayCancel(options)
                    .then((response: any) => {
                        resolve(response);
                    })
                    .catch((error: any) => {
